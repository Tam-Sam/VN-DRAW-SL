!(function (t) {
	...
	return (function t(i, n, e) {
		...
		for (var a = 'function' == typeof require && require, h = 0; h < e.length; h++) r(e[h]);
		return r;
	})(
		{
			1: [
				function (t, i, n) {
					...
					function h(t, i, n, e, r) {
						(r || (r = p(null)),
							...
							(r.maxX = -(1 / 0)),
							(r.maxY = -(1 / 0)));
						for (var a, h = i; h < n; h++) ((a = t.children[h]), o(r, t.leaf ? e(a) : a));
						return r;
					}
					function o(t, i) {
						return (
					...
					e.prototype = {
						...
						search: function (t) {
							...
							for (var r, a, h, o, s = []; i;) {
								for (r = 0, a = i.children.length; r < a; r++)
									((h = i.children[r]),
										(o = i.leaf ? e(h) : h),
										x(t, o) && (i.leaf ? n.push(h) : d(t, o) ? this._all(h, n) : s.push(h)));
								i = s.pop();
							}
							return n;
						},
						...
						remove: function (t, i) {
							if (!t) return this;
							for (
								var n, e, a, h, o = this.data, s = this.toBBox(t), l = [], f = [];
								o || l.length;
							) {
								if (
									(o || ((o = l.pop()), (e = l[l.length - 1]), (n = f.pop()), (h = !0)),
								...
								h || o.leaf || !d(o, s)
									? e
										...
										: (o = null)
									: (l.push(o), f.push(n), (n = 0), (e = o), (o = o.children[0]));
							}
							return this;
						},
						toBBox: function (t) {
						...
						_build: function (t, i, n, e) {
							...
							for (M(t, i, n, m, this.compareMinX), s = i; s <= n; s += m)
								for (
									f = Math.min(s + m - 1, n), M(t, s, f, c, this.compareMinY), l = s;
									l <= f;
									l += c
								)
