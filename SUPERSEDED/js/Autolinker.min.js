...
!(function (e, t) {
	...
	var r = (function () {
			...
			return (
				...
				(e.prototype.createCssClass = function (e) {
					...
					if (t) {
						for (var u = [t], n = e.getCssClassSuffixes(), r = 0, a = n.length; r < a; r++)
							u.push(t + '-' + n[r]);
						return u.join(' ');
					}
					return '';
				...
				(e.prototype.doTruncate = function (e) {
					...
					return 'smart' === o
						? (function (e, t, i) {
								var u, n;
								u = null == i ? ((i = '&hellip;'), (n = 3), 8) : ((n = i.length), i.length);
								var r = function (e) {
										var t = '';
										return (
								...
								if (e.length <= t) return e;
								if (
									(l.host && ((l.host = l.host.replace(/^www\./, '')), (e = r(l))), e.length <= t)
								)
									return e;
								var g = '';
								if ((l.host && (g += l.host), g.length >= h))
									return l.host.length == t
										...
										: a(g, h).substr(0, h + u);
								var f = '';
								if ((l.path && (f += '/' + l.path), l.query && (f += '?' + l.query), f)) {
									if (h <= (g + f).length)
										return (g + f).length == t
											? (g + f).substr(0, t)
						...
						: 'middle' === o
							? (function (e, t, u) {
									...
									var n,
										r =
											t - (null == u ? ((u = '&hellip;'), (n = 8), 3) : ((n = u.length), u.length)),
										a = '';
									return (
	...
	function a(e, t) {
		...
		(n(e, t),
			(e.prototype = null === t ? Object.create(t) : ((u.prototype = t.prototype), new u())));
	}
	var _ = function () {
			return (_ =
				Object.assign ||
					...
					function v() {
						if (h.hasDomainDot) {
							...
							((u = (t.split('.').pop() || '').toLowerCase()),
								a.test(u) &&
									i.push(new w({ tagBuilder: r, matchedText: e, offset: h.idx, email: t })));
						}
						var u;
						F();
					}
		...
		k = (function (u) {
			function e(e) {
				...
				return (
					(t.serviceName = 'twitter'),
					(t.matcherRegex = new RegExp('#[_' + d + ']{1,139}(?![_' + d + '])', 'g')),
					...
					for (
						...
						if (0 === s || n.test(o)) {
							var c = t[0],
								h = t[0].slice(1);
							i.push(
								new l({ tagBuilder: a, matchedText: c, offset: s, serviceName: r, hashtag: h })
							);
						}
					}
					return i;
				...
				(e.prototype.parseMatches = function (e) {
					for (
						...
						this.testMatch(t[3]) &&
							...
							h &&
							r.push(
								new g({ tagBuilder: n, matchedText: a, offset: t.index, number: i, plusSign: s })
							);
					}
					return r;
				}),
			...
			function e(e) {
				...
				return (
					...
					(t.matcherRegexes = {
						...
						soundcloud: new RegExp('@[-_.' + d + ']{1,50}(?![-_' + d + '])', 'g')
					}),
					(t.nonWordCharRegex = new RegExp('[^' + d + ']')),
					(t.serviceName = e.serviceName),
					t
					...
					for (; null !== (t = n.exec(e));) {
						...
						if (0 === s || r.test(o)) {
							var c = t[0].replace(/\.+$/g, ''),
								h = c.slice(1);
							i.push(
								new p({ tagBuilder: a, matchedText: c, offset: s, serviceName: u, mention: h })
							);
						}
					}
					return i;
		...
		function m(e) {
			'!' === e
				...
				: '/' === e
					...
					: '<' === e
						? S()
						: (g = W.test(e) ? ((l = 3), new V(_({}, g, { isOpening: !0 }))) : ((l = 0), o));
		}
		function A(e) {
			L.test(e)
	...
	return (function () {
		function n(e) {
			(void 0 === e && (e = {}),
				...
				(this.newWindow = 'boolean' == typeof e.newWindow ? e.newWindow : this.newWindow),
				...
				(this.decodePercentEncoding =
					'boolean' == typeof e.decodePercentEncoding
						...
						: this.decodePercentEncoding));
			var t = this.mention;
			if (!1 !== t && 'twitter' !== t && 'instagram' !== t && 'soundcloud' !== t)
		...
		return (
			...
			(n.prototype.normalizeTruncateCfg = function (e) {
				return 'number' == typeof e
					...
					: (function (e, t) {
							for (var u in t) t.hasOwnProperty(u) && void 0 === e[u] && (e[u] = t[u]);
							return e;
							...
							if (0 === a) {
								var u = (function (e, t) {
										...
										for (var u, n = [], r = 0; (u = t.exec(e));)
											(n.push(e.substring(r, u.index)), n.push(u[0]), (r = u.index + u[0].length));
			...
			(n.prototype.parseText = function (e, t) {
				(void 0 === t && (t = 0), (t = t || 0));
				for (var u = this.getMatchers(), n = [], r = 0, a = u.length; r < a; r++) {
			...
			(n.prototype.link = function (e) {
				if (!e) return '';
				for (var t = this.parse(e), u = [], n = 0, r = 0, a = t.length; r < a; r++) {
					var i = t[r];
			...
			(n.HtmlTag = u),
			(n.matcher = { Email: v, Hashtag: k, Matcher: i, Mention: M, Phone: T, Url: E }),
			(n.match = { Email: w, Hashtag: l, Match: e, Mention: p, Phone: g, Url: F }),
			n
		);
	})();
});
